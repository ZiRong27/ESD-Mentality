          ...
          <div class="row">
            <div class="col-md-9 col-lg-8 mx-auto">
              ...
              <form id="loginForm">
                ...
                <button class="btn btn-lg btn-primary btn-block btn-login text-uppercase font-weight-bold mb-2" id="loginBtn" type="submit">Sign in</button>
                <div class="text-center">
                  <br> 
                  <a class="medium font-weight-bold .text-secondary" href="register.php">Register new account</a>
                </div>
              </form>
